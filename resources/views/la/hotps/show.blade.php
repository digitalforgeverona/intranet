...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $hotp->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Hotps", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/hotps/'.$hotp->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Hotps", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.hotps.destroy', $hotp->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/hotps') }}" data-toggle="tooltip" data-placement="right" title="Back to Hotps"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'invoicenr')
						@la_display($module, 'number')
						@la_display($module, 'sentdate')
					</div>
				</div>
			</div>
		</div>
